...
| 8.3.26    | 8.3.26      | amd64/arm64  | ✅ Everything                                                                                             |
| 8.4.14rc1 | 8.4.14rc1   | amd64/arm64  | ✅ Everything                                                                                             |
| 8.5.0rc2  | 8.5.0rc2    | amd64/arm64  | ❌ Missing xdebug extension                                                                               |
...
```bash
docker run --rm curder/laravel-docker:8.4.13 php -v
```
...
- GitHub Mirror
    ...
    ```bash
    docker run --rm ghcr.io/curder/laravel-docker:8.4.13 php -v
    ```

- Ali Mirror

    ```bash
    docker run --rm registry.cn-hangzhou.aliyuncs.com/curder/laravel-docker:8.4.13 php -v
    ```
